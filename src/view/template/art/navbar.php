<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fdfdfd">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" href="<?= BASEURL.'/src/view/art' ?>">Cari Kerja</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= BASEURL.'/src/view/art/job/my-job.php' ?>">Daftar Pekerjaanku</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= BASEURL.'/src/view/art/settings' ?>">Pengaturan</a>
				</li>
				<li class="nav-item">
