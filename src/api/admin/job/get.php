...
$query = "
	SELECT job_vacancy.id, job_vacancy.photo_id, job_vacancy.job_description, job_vacancy.job_payment, job_vacancy.job_due_date, art_finder.full_name AS finder, photos.photo_url AS thumbnail
	FROM job_vacancy
